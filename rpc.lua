...
--st.spawn("st.spawn",  "rpctest", 1,2,3,5);
--print( rpc_call("rpcb@127.0.0.1", "rpctest", 1,2,3,5) );
print( rpc_call("rpcb@127.0.0.1", "rp.rp12.stest", 2,3,4,5) )
--rs, pid = rpc_call("rpcb@127.0.0.1", "st.spawn", "rpctest", 2,3,4,5);
--print( string.format("%d", pid) )
--rpcsrv_main();
--print(_G.rpctest);
